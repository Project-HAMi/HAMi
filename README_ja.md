...
- **ヘテロジニアス AI クラスター**：NVIDIA GPU、NPU、DCU、MLU、XPU など、1 つのスケジューリングおよび割り当てワークフローで複数のアクセラレータタイプを管理します。
...
- NVIDIA、Ascend、Cambricon、Hygon、Iluvatar、MetaX、Moore Threads、Kunlunxin など、複数ベンダーのヘテロジニアスアクセラレータクラスターの運用。
