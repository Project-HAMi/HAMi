...
// "higher score is a better node" convention. MetaxDevices implements
...
// "scores" map where higher is better and a "losses" map where lower is
// better. The scores annotation is used directly; when it is absent the
// losses annotation is converted onto the same "higher is better" scale.
