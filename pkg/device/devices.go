...
type Devices interface {
	...
	CustomFilterRule(allocated *util.PodDevices, toAllocate util.ContainerDevices, device *util.DeviceUsage) bool
...
func PodAllocationTrySuccess(nodeName, devName, lockName string, pod *corev1.Pod) {
...
func PodAllocationSuccess(nodeName string, pod *corev1.Pod, lockName string) {
	...
	if err := nodelock.ReleaseNodeLock(nodeName, lockName); err != nil {
