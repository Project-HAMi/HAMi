	...
	tests := []struct {
		...
		},
		{
			...
			deviceUsage: &device.DeviceUsage{
				...
				MigTemplate: []device.Geometry{
					{
						{Name: "1g.5gb", Memory: 5120, Count: 1},
					},
					{
						{Name: "1g.5gb", Memory: 5120, Count: 1},
						{Name: "2g.10gb", Memory: 10240, Count: 1},
					},
				},
		...
		},
		{
			...
			deviceUsage: &device.DeviceUsage{
				...
				MigTemplate: []device.Geometry{
					{
						{Name: "1g.3gb", Memory: 3072, Count: 1},
					},
					{
						{Name: "1g.5gb", Memory: 5120, Count: 1},
						{Name: "2g.10gb", Memory: 10240, Count: 1},
		...
		},
		{
			...
			deviceUsage: &device.DeviceUsage{
				...
				MigTemplate: []device.Geometry{
					...
					{
						{Name: "3g.20gb", Memory: 20480, Count: 1},
					},
				},
				MigUsage: device.MigInUse{
					UsageList: make(device.MIGS, 0),
				...
				MigTemplate: []device.Geometry{
					{
						...
						{Name: "1g.5gb", Memory: 5120, Count: 2},
						{Name: "2g.10gb", Memory: 10240, Count: 1},
					},
				},
				MigUsage: device.MigInUse{
