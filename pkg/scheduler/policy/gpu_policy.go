...
type DeviceUsageList struct {
	...
	// hami.io/topology-aware-scoring: "false" annotation (#1806). When false
	// (the default) devices are grouped by NUMA so Fit can accumulate a
	// contiguous same-NUMA run.
	NumaIgnore bool
}
