					...
					NodeList: []*policy.NodeScore{
						{
							...
							Devices: device.PodDevices{
								"NVIDIA": device.PodSingleDevice{
									// Index 0: InitContainer successfully allocated to uuid1
									{
										{
											Idx:       0,
											UUID:      "uuid2",
									...
									// Index 1: Regular Container successfully allocated to uuid1
									// (Proves that the node state reset correctly after the InitContainer)
									{
										{
											Idx:       0,
											UUID:      "uuid2",
